...
module.exports = (deployer) => {
    deployer.deploy(Collectables).then(async function(instance) {
        ...
        await instance.createNewEscaperoom(accounts[5], "Escape Room 1", 1000);
        await instance.createNewEscaperoom(accounts[6], "Escape Room 2", 1000);
        await instance.createNewEscaperoom(accounts[7], "Escape Room 3", 1000);
        await instance.createNewEscaperoom(accounts[8], "Escape Room 4", 1000);
        await instance.createNewEscaperoom(accounts[9], "Escape Room 5", 1000);
